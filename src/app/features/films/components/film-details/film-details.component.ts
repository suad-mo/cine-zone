...
export class FilmDetailsComponent implements OnInit {
  ...
  reserveProjection(projectionId: number): void {
    ...
    if (projection) {
      ...
      this._projectionService.setSelectedDate(
        projection.dateTime.toString().split('T')[0]
      );
      ...
      this._router.navigate(['/reservations/new'], {
        queryParams: {
          idProjection: projectionId,
          // idFilm,
          // idLocation,
          // dateTime,
          // idHall,
